...
<form method="POST" action="./sr_update_submit.php" class="form-horizontal">
...
<div class="form-group">
    ...
    <p class="text-center"><input type="submit" name="submit" class="btn btn-default btn-lg" value="編集を完了する"></p>

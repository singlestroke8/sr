...
<form method="POST" action="./sr_delete_submit.php" class="form-horizontal">
...
<div class="form-group">
    ...
    <p class="text-center"><input type="submit" name="submit" class="btn btn-default btn-lg" value="設問を削除する"></p>

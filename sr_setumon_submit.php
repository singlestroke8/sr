...
if (isset($_POST["submit"])){
    ...
    $sql = "INSERT INTO kakomon ( kamoku, year, num, kigou, setsumon, seitou, kaisetsu, touroku )
            VALUES ( :kamoku, :setsumonYear, :setsumonNum, :setsumonKigou, :setsumon, :seitou, :kaisetsu, NOW() )";
    ...
    if ( $error[0] != "00000" ){
        $message = "データ追加失敗{$error[2]}";
    } else {
        $message = "データ追加成功。データ番号：".$conn->lastInsertId();
    }
